...
/*   Updated: 2023/12/08 14:19:30 by ljerinec         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ClapTrap::beRepaired(unsigned int amount)
{
	...
	else
	{
		this->_health += amount;
		this->_energy--;
		std::cout << "ClapTrap " << this->_name << " got " << amount << " hp ! total health is " << this->_health << " hp ! " << this->_energy << " Energy point(s)"<< std::endl;
	}
}
